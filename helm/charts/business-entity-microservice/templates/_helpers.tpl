...
*/}}
{{- define "business-entity-microservice.name" -}}
...
*/}}
{{- define "business-entity-microservice.fullname" -}}
...
*/}}
{{- define "business-entity-microservice.chart" -}}
...
Common labels
*/}}
{{- define "business-entity-microservice.labels" -}}
helm.sh/chart: {{ include "business-entity-microservice.chart" . }}
{{ include "business-entity-microservice.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "business-entity-microservice.selectorLabels" -}}
app.kubernetes.io/name: {{ include "business-entity-microservice.name" . }}
...
Namespace
*/}}
{{- define "business-entity-microservice.namespace" -}}
...
Web-App Port
*/}}
{{- define "business-entity.webExternalPort" -}}
...
*/}}
{{- define "business-entity.iamPort" -}}
